...
exportgraphics(gcf, sprintf('figs/rfs_paper_merged_%s.jpeg',sta_name), ...
    'Resolution', 700); % Save figure. 
...
exportgraphics(gcf, sprintf('figs/rfs_%s.jpeg',sta_name), ...
